...
export const DEMO_PASSWORD = "CareBridgeDemo!2026";
...
> = {
  ...
  clinician: {
    email: "clinician@carebridge.demo",
  ...
  ministry: {
    email: "ministry@carebridge.demo",
    name: "Nadine Joseph",
    role: "ministry",
