...
export const Route = createFileRoute("/_authenticated/consent")({
  head: () => ({
    meta: [
      { title: "Consent Ledger — Cross-Border Record Sharing | CariCare Grid" },
      {
        name: "description",
        content:
          "Patient-approved, scoped, time-limited and fully auditable record sharing between Caribbean islands. The blocker to interoperability is legal, not technical.",
      },
