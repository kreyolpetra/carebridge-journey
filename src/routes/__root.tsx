  ...
  head: () => ({
    meta: [
      ...
      { title: "CareBridge Journey — Caribbean Health Coordination Layer" },
      {
        name: "description",
        content:
          "One patient identity, one record, one triage brain, one capacity-aware routing engine across the Caribbean.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Outfit:wght@500;600;700&family=Figtree:wght@400;500;600;700&family=IBM+Plex+Mono:wght@400;500&display=swap",
      },
